...
step_time = int(300) #in milliseconds, See LIA's time constant e.g. 30ms with 24 dB. step time = 30ms *10 =300ms
...
#loop over and read the signal from the lockin and append the value to the intensity array
