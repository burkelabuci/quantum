...
#    seq.setDigital(1, [(tau_i_ns, 1), ((tau_ref_ns-tau_i_ns), 0),((tau_i_ns), 1),((tau_delay_ns),0),((tau_i_ns), 1), ((tau_ref_ns-2*tau_i_ns-tau_delay_ns), 0)])
    ...
    #pulse_patt_decay_gate = create_fig_4_gating_pattern_array_rounded_to_8_ns_version_2(tau_ref_ns, tau_laser_ns, tau_mw_ns,tau_padding_before_mw_ns,tau_padding_after_mw_ns, n_repeats,1)
    #seq.setDigital(4,pulse_patt_decay_gate) 
    
    #pulse_patt_decay_DAQ = create_fig_4_gating_pattern_array_rounded_to_8_ns_version_2(tau_ref_ns, tau_laser_ns, tau_mw_ns,tau_padding_before_mw_ns,tau_padding_after_mw_ns, n_repeats,1)
    #seq.setDigital(0,pulse_patt_decay_DAQ) 
...
def create_fig3_teachingpaper_pulse_sequence_repeated(channel_number_ref,channel_number_pulse,channel_number_gating_pulses,tau_ref_ns,tau_i_ns,tau_delay_ns,number_of_cycles,ps: PulseStreamer):
    # Creates patter in fig 3 of teaching paper
    # ps is the pulsestreamer object
    # duration is how long the stream runs for in seconds
...
def create_fig3_teachingpaper_pulse_sequence_repeated_SPD(channel_number_ref,channel_number_pulse,channel_number_gating_pulses,tau_ref_ns,tau_i_ns,tau_delay_ns,number_of_cycles,ps: PulseStreamer):
    # Creates patter in fig 3 of teaching paper
    # ps is the pulsestreamer object
    # duration is how long the stream runs for in seconds
    ...
    pulse_patt_decay = create_pattern_array_rounded_to_8_ns_SPD(tau_ref_ns, tau_i_ns, tau_delay_ns, number_of_cycles)
    #print("++++++++++++++++++++++++++++++++++++++++++++++++++++")
    #print("pulse_patt_decay sum=",sum_first_elements(pulse_patt_decay))
    #print("pulse_patt_decay sum divided by 8 ns=",sum_first_elements(pulse_patt_decay)/8)
...
def create_fig4_teachingpaper_pulse_sequence_repeated(channel_number_ref,channel_number_laser_pulse,channel_number_mw_pulse,channel_number_gating_pulses,tau_ref_ns,tau_laser_ns,mw_pulse_length_ns,tau_padding_before_mw_ns,tau_padding_after_mw_ns,n_repeats,number_of_cycles,ps: PulseStreamer):
    # called by    
...
def do_it_all(channel_number_ref,channel_number_pulse,channel_number_gating_pulses,tau_ref_ns,tau_i_ns,number_of_cycles,delay_start_s,delay_stop_s,delay_number_of_points,ps):
    ...
    sequences = [create_fig3_teachingpaper_pulse_sequence_repeated(channel_number_ref, channel_number_pulse, channel_number_gating_pulses,tau_ref_ns, tau_i_ns, delay*1e9, number_of_cycles, ps) for delay in delays]
...
def do_it_all_SPD(channel_number_ref,channel_number_pulse,channel_number_gating_pulses,tau_ref_ns,tau_i_ns,number_of_cycles,delay_start_s,delay_stop_s,delay_number_of_points,ps):
    ...
    # Create sequences using the non-integer delays
    sequences = [create_fig3_teachingpaper_pulse_sequence_repeated_SPD(channel_number_ref, channel_number_pulse, channel_number_gating_pulses,tau_ref_ns, tau_i_ns, delay*1e9, number_of_cycles, ps) for delay in delays]
...
def rabi_many_sequences(channel_number_ref,channel_number_laser_pulse,channel_number_mw_pulse,channel_number_gating_pulses,tau_ref_ns,tau_laser_ns,mw_pulse_length_start_ns,mw_pulse_length_stop_ns,mw_pulse_length_number_of_points,tau_padding_before_mw_ns,tau_padding_after_mw_ns,n_repeats,number_of_cycles,ps):
    ...
    sequences= [create_fig4_teachingpaper_pulse_sequence_repeated(channel_number_ref,channel_number_laser_pulse,channel_number_mw_pulse,channel_number_gating_pulses,tau_ref_ns,tau_laser_ns,mw_pulse_length_ns,tau_padding_before_mw_ns,tau_padding_after_mw_ns,n_repeats,number_of_cycles,ps)for mw_pulse_length_ns in mw_pulse_lengths_ns]
...
def Hahn_many_sequences(channel_number_ref,channel_number_laser_pulse,channel_number_mw_pulse,channel_number_mw_phaseshifted_pulse,
    ...
    #ps.stream(result_sequence)  # runs forever , but returns program
    return sequences
def Hahn_many_sequences_XYX(channel_number_ref,channel_number_laser_pulse,channel_number_mw_pulse,channel_number_mw_phaseshifted_pulse,
                        tau_ref_ns,tau_laser_ns,
                        tau_mw_X_pi_over_2_ns,tau_mw_X_pi_ns,tau_mw_Y_pi_ns,
                        mw_T_delay_length_start_ns,mw_T_delay_length_stop_ns,mw_T_delay_length_number_of_points,
                        tau_padding_before_mw_pi_over_2_ns,tau_padding_after_mw_pi_over_2_ns,
    ...
    sequences= [create_fig5_teachingpaper_pulse_sequence_repeated_XYX(channel_number_ref,channel_number_laser_pulse,channel_number_mw_pulse,channel_number_mw_phaseshifted_pulse,
                                                                tau_ref_ns,tau_laser_ns,
                                                                tau_mw_X_pi_over_2_ns,tau_mw_X_pi_ns,tau_mw_Y_pi_ns,
                                                                mw_T_delay_length_ns,
                                                                tau_padding_before_mw_pi_over_2_ns,tau_padding_after_mw_pi_over_2_ns,
...
def create_pattern_array_rounded_to_8_ns_SPD(tau_ref_ns, tau_i_ns, tau_delay_ns, n):
    #round_to_nearest_8ns(value)
    tau_ref_ns_rounded=round_to_nearest_8ns(tau_ref_ns)
    tau_i_ns_rounded=round_to_nearest_8ns(tau_i_ns)
    tau_delay_ns_rounded=round_to_nearest_8ns(tau_delay_ns)
    ...
    pattern = [
        (tau_i_ns_rounded, 1), (tau_delay_ns_rounded, 0),(tau_i_ns_rounded, 1),((tau_ref_ns_rounded - 2 * tau_i_ns_rounded - tau_delay_ns_rounded), 0), 
        (tau_i_ns_rounded, 1), 
        (tau_delay_ns_rounded, 0), 
        (tau_i_ns_rounded, 1), 
        ((tau_ref_ns_rounded - 2 * tau_i_ns_rounded - tau_delay_ns_rounded), 0)
...
def create_pattern_array_gating_rounded_to_8_ns(tau_ref_ns, tau_i_ns, tau_delay_ns, n):
    ...
    pattern = [
        (tau_i_ns_rounded, 0), (tau_delay_ns_rounded, 0),(tau_i_ns_rounded, 1),((tau_ref_ns_rounded - 2 * tau_i_ns_rounded - tau_delay_ns_rounded), 0), 
        (tau_i_ns_rounded, 0), 
        (tau_delay_ns_rounded, 0), 
        (tau_i_ns_rounded, 1), 
        ((tau_ref_ns_rounded - 2 * tau_i_ns_rounded - tau_delay_ns_rounded), 0)
...
def create_fig_4_gating_pattern_array_rounded_to_8_ns_version_2(tau_ref_ns, tau_laser_ns, tau_mw_ns,tau_padding_before_mw_ns,tau_padding_after_mw_ns,tau_gate_on_ns,tau_gate_off_ns, n_repeat,n):
    ...
    pattern_1_subunit = [ # maybe this needs to be an integral multiple of 8 ns
        ...
        (tau_gate_on_ns,1),(tau_gate_off_ns,0),(tau_gate_on_ns,1),
        (tau_padding_before_mw_ns+tau_mw_ns_int+tau_padding_after_mw_ns,0)
    ]
...
#    pattern_1_end_time_ns=tau_ref_ns_rounded-n_repeat*(tau_laser_ns+tau_mw_ns_rounded_to_10ps+tau_padding_before_mw_ns+tau_padding_after_mw_ns)
    pattern_1_end_time_ns=tau_ref_ns-int(n_repeat/2)*total_time
    pattern_1_end=[
        (pattern_1_end_time_ns,0)
    ]
    if(pattern_1_end_time_ns<0):
    ...
    pattern_1=pattern_1_subunit*int(n_repeat/2)+pattern_1_end # this may not be a multiple of 8 ns:
    ...
    pattern_2=pattern_2_subunit*int(n_repeat/2) + pattern_2_end
...
def  create_fig_5_mw_pattern_array(tau_ref_ns,tau_laser_ns,
    ...
    pattern_1_subunit = [
        ...
        (mw_T_delay_length_ns,0),
        (tau_mw_X_pi_over_2_ns, 1),
        (tau_laser_off_time_subunit-tau_padding_before_mw_pi_over_2_ns-tau_mw_X_pi_over_2_ns-mw_T_delay_length_ns-tau_mw_X_pi_ns-mw_T_delay_length_ns-tau_mw_X_pi_over_2_ns,0)
    ]
    total_time = sum(pair[0] for pair in pattern_1_subunit)
...
def  create_fig_5_mw_Y_pattern_array(tau_ref_ns,tau_laser_ns,
    ...
    tau_padding_after_mw_pi_over_2_ns=int(tau_padding_after_mw_pi_over_2_ns)
    tau_laser_off_time_subunit= tau_padding_before_mw_pi_over_2_ns+tau_mw_X_pi_over_2_ns+mw_T_delay_length_ns+tau_mw_X_pi_ns+mw_T_delay_length_ns+tau_mw_Y_pi_ns+tau_padding_after_mw_pi_over_2_ns
    tau_mw_X_pi_off_time_subunit=tau_laser_off_time_subunit-tau_padding_before_mw_pi_over_2_ns-tau_mw_X_pi_over_2_ns-mw_T_delay_length_ns-tau_mw_X_pi_ns-mw_T_delay_length_ns-tau_mw_X_pi_over_2_ns
    
    pattern_1_subunit = [
        (tau_laser_ns+tau_padding_before_mw_pi_over_2_ns+mw_T_delay_length_ns+ tau_mw_X_pi_over_2_ns, 0), 
        (tau_mw_Y_pi_ns, 1),
        (tau_mw_X_pi_off_time_subunit+mw_T_delay_length_ns+tau_mw_X_pi_over_2_ns,0)
    ]
    total_time = sum(pair[0] for pair in pattern_1_subunit)
    print("create_fig_5_mw_pattern_array:total_time=",total_time)
...
def create_fig5_teachingpaper_pulse_sequence_repeated_XYX(channel_number_ref,channel_number_laser_pulse,channel_number_mw_pulse,channel_number_mw_phaseshifted_pulse,
                                                    tau_ref_ns,tau_laser_ns,
                                                    tau_mw_X_pi_over_2_ns,tau_mw_X_pi_ns,tau_mw_Y_pi_ns,
                                                    mw_T_delay_length_ns,
                                                    tau_padding_before_mw_pi_over_2_ns,tau_padding_after_mw_pi_over_2_ns,
    ...
    #*********** THEN PULSE CYCLE MW X***********************
    pulse_patt_mw_X = create_fig_5_mw_pattern_array_XYX(tau_ref_ns,tau_laser_ns,
                                                    tau_mw_X_pi_over_2_ns,tau_mw_X_pi_ns,tau_mw_Y_pi_ns,
                                                    mw_T_delay_length_ns,
                                                    tau_padding_before_mw_pi_over_2_ns,tau_padding_after_mw_pi_over_2_ns,
                                                    n_repeats,number_of_cycles)
...
def  create_fig_5_mw_pattern_array_XYX(tau_ref_ns,tau_laser_ns,
                                    tau_mw_X_pi_over_2_ns,tau_mw_X_pi_ns,tau_mw_Y_pi_ns,
                                    mw_T_delay_length_ns,
                                    tau_padding_before_mw_pi_over_2_ns,tau_padding_after_mw_pi_over_2_ns,
                                    n_repeats,number_of_cycles):
    ...
    pattern_1_subunit = [
        (tau_laser_ns+tau_padding_before_mw_pi_over_2_ns, 0), 
        (tau_mw_X_pi_over_2_ns, 1),
        (mw_T_delay_length_ns+mw_T_delay_length_ns+tau_mw_Y_pi_ns,0),
        (tau_mw_X_pi_over_2_ns, 1),
        (tau_laser_off_time_subunit-tau_padding_before_mw_pi_over_2_ns-tau_mw_X_pi_over_2_ns-mw_T_delay_length_ns-tau_mw_Y_pi_ns-mw_T_delay_length_ns-tau_mw_X_pi_over_2_ns,0)
    ]
    total_time = sum(pair[0] for pair in pattern_1_subunit)
    print("create_fig_5_mw_pattern_array:total_time=",total_time)
...
def  create_fig4_teachingpaper_pulse_sequence_doublelockin(tau_second_lockin_ns,tau_ref_ns,tau_laser_ns,tau_mw_ns,tau_padding_before_mw_ns,tau_padding_after_mw_ns,n_repeats,ps):
    # Creates microwave chaopping pattern only in fig 4 of teaching paper
    # ps is the pulsestreamer object
    # n_repeats is how long many repeats per cycle
...
def create_fig4_teachingpaper_pulse_sequence_SPD(tau_ref_ns,tau_laser_ns,tau_mw_ns,tau_padding_before_mw_ns,tau_padding_after_mw_ns,tau_gate_on_ns,tau_gate_off_ns,n_repeats,ps: PulseStreamer):
    # Creates patter in fig 4 of teaching paper
    # n_repeats is how long many repeats per cycle
    ...
    seq.setDigital(0, [(tau_ref_ns,0), (tau_ref_ns, 1)])
...
#    seq.setDigital(1, [(tau_i_ns, 1), ((tau_ref_ns-tau_i_ns), 0),((tau_i_ns), 1),((tau_delay_ns),0),((tau_i_ns), 1), ((tau_ref_ns-2*tau_i_ns-tau_delay_ns), 0)])
    ...
    pulse_patt_decay_gate = create_fig_4_gating_pattern_array_rounded_to_8_ns_version_2(tau_ref_ns, tau_laser_ns, tau_mw_ns,tau_padding_before_mw_ns,tau_padding_after_mw_ns,tau_gate_on_ns,tau_gate_off_ns, n_repeats,1)
    seq.setDigital(4,pulse_patt_decay_gate) 
